...
/**
 * Search parts by part number and specific manufacturer. Return a maximum of 50 parts.
 */
export type SearchByPartMfrRequest = {
  /**
   * Used for filtering by a specific manufacturer. Please get the manufacturerId from the GetManufacturerList method.
   */
